...
public class View extends Canvas implements KeyListener, NodeExtender {
    ...
    public void start() {
        try {
            ...
            collada = ColladaLoader.load("/res/animation/flag.dae");
            cameraCollada = ColladaLoader.load("/res/animation/camera.dae");
            
            camera = cameraCollada.getLibraries().getCameras().get("#Camera-camera");
            collada.getScene().addChild(camera.getParent());
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            frame.setTitle("Collada (Morph) Animation Test #3");
